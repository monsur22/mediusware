<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select name="account_type" id="account_type" class="block mt-1 w-full" required>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="balance" class="block mt-1 w-full" type="number" name="balance" value="0" required autocomplete="username" />
